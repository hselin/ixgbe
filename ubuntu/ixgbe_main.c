...
static void ixgbe_setup_mrqc(struct ixgbe_adapter *adapter)
{
	...
	for (i = 0; i < 10; i++)
	{
		...
		printk("WRITING RSSRK[%d] with 0x%x\n", i, seed[i]);
	}
	...
	for (i = 0, j = 0; i < 128; i++, j++) {
		...
		if ((i & 3) == 3)
		{
			...
			printk("WRITING RETA: %d with 0x%x\n", i >> 2, reta);
		}
	}
#endif
#if 0
	for (i = 0; i < 10; i++)
	{
		IXGBE_WRITE_REG(hw, IXGBE_RSSRK(i), 0x5a6d5a6d);
		printk("WRITING RSSRK[%d] = 0x%x\n", i, 0x5a6d5a6d);
	}
#endif
#if 0
	for(i=0;i<32;i++)
	{
		...
		IXGBE_WRITE_REG(hw, IXGBE_RETA(i), reta);
                printk("NOW WRITING RETA: %d with 0x%x\n", i, reta);
	}
#endif
#if 0
	for(i=0; i < 32; i++)
    ...
    {
            if(i <= 7) reta = 0;
			else if((i > 7) && (i <=15)) reta = 0x1010101;
			else if((i > 15) && (i <=23)) reta = 0x2020202;
            else reta = 0x3030303; 
	...
	//IXGBE_WRITE_REG(hw, IXGBE_MRQC, 0x410001);
	//printk("NOW WRITING IXGBE_MRQC with 0x%x\n", 0x410001);
	...
	//mrqc |= IXGBE_MRQC_RSS_FIELD_IPV4_TCP | IXGBE_MRQC_RSS_FIELD_IPV4_UDP;
